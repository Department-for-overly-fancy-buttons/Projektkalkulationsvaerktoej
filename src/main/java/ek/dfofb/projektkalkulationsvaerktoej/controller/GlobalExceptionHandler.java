...
@ExceptionHandler(ProjectNotFoundException.class)
    public String handleProjectNotFoundException(ProjectNotFoundException exception, Model model) {
    ...
    public String handleDuplicateProjectException(DuplicateProjectException exception, Model model) {
    ...
    public String handleDuplicateAccountException(DuplicateAccountException exception, Model model) {
        model.addAttribute("status", HttpStatus.CONFLICT.value());
        model.addAttribute("errorType", "Duplicate entry");
        model.addAttribute("message", exception.getMessage());
        return "error/error";
